...
e<-read_csv(file='/Users/psav050/Documents/Research/Publications/Accepted/Savage et al (2025) PCI-RR Many Voices 2/MV2 real data/Many Voices 2 post-experiment survey (for experimenter)_November 30, 2025_14.39.csv')#import from main Qualtrics account output - not shared publicly
...
d<-read_csv(file='/Users/psav050/Documents/Research/Publications/Accepted/Savage et al (2025) PCI-RR Many Voices 2/MV2 real data/song_November 30, 2025_14.39.csv')#import from main Qualtrics account output - not shared publicly
d<-d[-c(1:244,276:304,320:322,384:392,407,417:421,451:453,455:467,474,491:493,501:514,542:546,566:572,579:591,611,614,623:624,631:718,726:742,758:782,788:795,815:859,877:878,887:889,916:917,928,934,949,971:972,988:990,1016:1020,1026,1033:1035,1042:1048,1057:1067,1085:1091,1098,1105:1106,1127,1137:1141),]#Exclude pilot data (change from hard-coding?)
